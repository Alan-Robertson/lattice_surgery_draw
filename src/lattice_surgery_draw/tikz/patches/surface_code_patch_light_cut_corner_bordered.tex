      ...
      minimum width=3em,
           path picture={
               \node[yscale=-1,inner sep=0,outer sep=0] at (path picture bounding box.center){
                   \includegraphics[scale=\rescale, angle=270, origin=c]{../bulk/surface_code_patch_cut_corner_light}
               };
           }] at (0, 0) {};
...
\node[minimum height=3em,
      minimum width=3em,
           path picture={
               \node[yscale=-1,inner sep=0,outer sep=0] at (path picture bounding box.center){
                   \includegraphics[scale=\rescale]{../boundary/border_light}
               };
           }] at (0 - 4*\offset, 0.5 - \offset) {};

\node[minimum height=3em,
      minimum width=3em,
           path picture={
               \node[yscale=-1,inner sep=0,outer sep=0] at (path picture bounding box.center){
                   \includegraphics[scale=\rescale, angle=90, origin=c]{../boundary/border_light}
               };
           }] at (0.5 - \offset,0) {};
