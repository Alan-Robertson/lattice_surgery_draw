      ...
      minimum width=3em,
           path picture={
               \node[yscale=-1,inner sep=0,outer sep=0] at (path picture bounding box.center){
                   \includegraphics[scale=\rescale, angle=270, origin=c]{surface_code_corner_light}
               };
           }] at (0, 0) {};
...
\node[minimum height=3em,
      minimum width=3em,
           path picture={
               \node[yscale=-1,inner sep=0,outer sep=0] at (path picture bounding box.center){
                   \includegraphics[scale=\rescale]{border_light_short}
               };
           }] at (0, 0.5 - \offset) {};
...
\node[minimum height=3em,
      minimum width=3em,
           path picture={
               \node[yscale=-1,inner sep=0,outer sep=0] at (path picture bounding box.center){
                   \includegraphics[scale=\rescale, angle=90, origin=c]{border_light_short}
               };
