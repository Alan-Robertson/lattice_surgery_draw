...
% End Cap
    \fill[line width = 0.25 * \rescale,draw=black, opacity = 0.85,fill=yellow!40!red!10, rounded corners= \rescale *3pt] (0.15, 0.15) -- (0.15, 0.85) -- (0.85, 0.85) -- cycle ;

\fill[line width = 0.25 * \rescale,draw=black, opacity = 0.85,fill=yellow!40!red!10, rounded corners= \rescale *3pt] (5.85, 0.85) -- (5.15, 0.15) -- (5.85, 0.15) -- cycle ;
