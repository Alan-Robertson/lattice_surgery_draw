...
\begin{tikzpicture}[scale=\rescale]
 ...
 \foreach \x in {0, 2, 4}{
   ...
   \fill[line width = 0.25 * \rescale,draw=black, fill=gray, opacity = 0.85,rounded corners= \rescale *3pt] (\x + 0.15, 0.15) -- (\x + 1.15, 0.85) -- (\x+1.85, 0.85) -- (\x+0.85, 0.15)  -- cycle;
    ...
    % Endcap
    \filldraw[line width =0.25*\rescale, fill=yellow!40!red!10] (6, 0.15) -- (7, 0.85) to [bend left=85] (6, 0.15);
    \draw[line width = \rescale, dash pattern={on 0.5pt off 0.5pt on 0.5pt off 0.5pt}, gray] (6, 0) to[bend right=45] (6.5, 0.5);
    \draw[line width = \rescale, dash pattern={on 0.5pt off 0.5pt on 0.5pt off 0.5pt}, gray] (7, 1) to[bend left=45] (6.5, 0.5);
