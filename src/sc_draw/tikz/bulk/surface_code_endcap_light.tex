...
\begin{tikzpicture}[]
    ...
    \draw[gray, fill=yellow!40!red!10] (0, 0) to [bend left=45] (-0.5, 0.5) to [bend left=45](0, 1) --cycle ; 


    % X Lattice
        \draw[thick, dash pattern={on 0.5pt off 0.5pt on 0.5pt off 0.5pt}, gray] (0, 0) -- (-0.5, 0.5) -- (0, 1);
